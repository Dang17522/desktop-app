...
public class NguoiHocDAO extends EduPolyDAO<NguoiHoc, String> {
    ...
    public void update(NguoiHoc entity) {
        XJDBC.update(UPDATE_SQL,
                ...
                entity.isGioiTinh(), entity.getDienThoai(), entity.getEmail(), entity.getGhiChu(), entity.getMaNV(), entity.getMaNH());
    ...
    //nhận vào 2 đối số là tìm người học theo họ tên và người học k có trong khóa học (không phải học viên)
